...
class OrganoidDataset(Dataset):
    def __init__(self, image_paths, labels, augment=False):
        ...
        self.transform = A.Compose([
            ...
            A.Resize(256, 256),  # 🔧 Añade esto también aquí
            A.CLAHE(clip_limit=2.0, tile_grid_size=(8,8)),
            A.Normalize(),
            ToTensorV2()
        ])
...
base_path = "/home/UNT/hel0057/Documents/Dataset"
...
def train_model(model, train_loader, val_loader, save_path):
    ...
    for epoch in range(50):
        ...
        print(f"Epoch {epoch+1}: Train Loss={np.mean(train_losses):.4f} | Val F1={f1:.4f}")
...
for channel in ["CH4", "CH1"]:
    ...
    checkpoint_path = f"resnet50_{channel}_best.pth"
